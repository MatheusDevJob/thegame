...
public static class EntityTexture2D
{
    public static Texture2D GetEntityTextureById(GameContext context, string entityId)
    {
        return entityId switch
        {
            ...
            "SementeRabanete" => context.Content.Load<Texture2D>("Items/radish_00"),
            "Rabanete01" => context.Content.Load<Texture2D>("Items/radish_01"),
            "Rabanete02" => context.Content.Load<Texture2D>("Items/radish_02"),
            "Rabanete03" => context.Content.Load<Texture2D>("Items/radish_03"),
            "Rabanete04" => context.Content.Load<Texture2D>("Items/radish_04"),
            "Rabanete" => context.Content.Load<Texture2D>("Items/radish_05"),

            "SementeGiraSol" => context.Content.Load<Texture2D>("Items/sunflower_00"),
            "GiraSol01" => context.Content.Load<Texture2D>("Items/sunflower_01"),
            "GiraSol02" => context.Content.Load<Texture2D>("Items/sunflower_02"),
            "GiraSol03" => context.Content.Load<Texture2D>("Items/sunflower_03"),
            "GiraSol04" => context.Content.Load<Texture2D>("Items/sunflower_04"),
            "GiraSol" => context.Content.Load<Texture2D>("Items/sunflower_05"),

            "SementeTrigo" => context.Content.Load<Texture2D>("Items/wheat_00"),
            "Trigo01" => context.Content.Load<Texture2D>("Items/wheat_01"),
            "Trigo02" => context.Content.Load<Texture2D>("Items/wheat_02"),
            "Trigo03" => context.Content.Load<Texture2D>("Items/wheat_03"),
            "Trigo04" => context.Content.Load<Texture2D>("Items/wheat_04"),
            "Trigo" => context.Content.Load<Texture2D>("Items/wheat_05"),
